...
const articles = [
  { category: "AI", color: "bg-secondary-dark/10 text-secondary-dark", title: "Woodo.ai Hosts Inaugural AI Summit at Columbia University", author: "David Dong", date: "Apr 2026", excerpt: "Featuring leaders from Google, Microsoft, Morgan Stanley, and more — a half-day program exploring AI across energy, finance, blockchain, and governance.", read: "8 min read", slug: "ai-summit-columbia", tags: ["Summit"], cover: aiSummitCover },
