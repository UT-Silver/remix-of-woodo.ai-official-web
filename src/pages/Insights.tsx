...
const articles = [
  ...
  { category: "Education", color: "bg-primary-dark/10 text-primary-dark", title: "The Judgment Gap", author: "Silver Yin", date: "Mar 2026", excerpt: "Why knowing how to build is no longer enough — and what we should teach instead.", read: "4 min read" },
  { category: "Education", color: "bg-secondary-dark/10 text-secondary-dark", title: "AI Literacy Is Not Enough", author: "Keer Wang", date: "Feb 2026", excerpt: "Literacy is baseline. We need fluency, taste, and the courage to create.", read: "6 min read" },
  { category: "Building", color: "bg-accent-dark/10 text-accent-dark", title: "What New Oriental Taught Us", author: "David Dong", date: "Feb 2026", excerpt: "Lessons from China's biggest education company — and why we chose a different path.", read: "7 min read" },
  { category: "Education", color: "bg-primary-dark/10 text-primary-dark", title: "On Radical Honesty in Education", author: "Silver Yin", date: "Jan 2026", excerpt: "Why we tell students the truth even when it's uncomfortable.", read: "4 min read" },
  { category: "AI", color: "bg-secondary-dark/10 text-secondary-dark", title: "Building vs. Optimizing: Two Mindsets", author: "Silver Yin", date: "Jan 2026", excerpt: "The difference between making things better and making things that matter.", read: "5 min read" },
];
    ...
    <div className="page-enter pt-20">
      ...
      <section className="relative min-h-[70vh] flex items-end px-6 pb-16">
        ...
        <ScrollReveal className="relative z-10 max-w-3xl mx-auto w-full">
          <span className="inline-block px-3 py-1 rounded-lg text-xs font-semibold bg-primary/20 text-primary-light mb-4">Founding</span>
          <h1 className="text-3xl md:text-4xl font-medium text-white">
            Why We Started <strong className="font-bold">Woodo</strong>
          </h1>
          <p className="mt-3" style={{ color: "rgba(255,255,255,0.5)" }}>Silver Yin · Mar 2026 · 5 min read</p>
          <span className="inline-block mt-4 text-sm font-semibold text-primary-light hover:text-primary transition-colors cursor-pointer group">
      ...
      {/* Article Grid — cool gray */}
      <section className="py-16 px-6 bg-cool-gray dot-grid-bg">
        <div className="max-w-4xl mx-auto relative z-10">
          {/* Large featured card first */}
          {filtered.length > 0 && (
            <ScrollReveal className="mb-8">
              <div className="border border-border rounded-2xl overflow-hidden bg-background card-hover cursor-pointer flex flex-col md:flex-row group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {filtered.slice(1).map((a, i) => (
              <ScrollReveal key={a.title} delay={i * 100}>
                <div className="border border-border rounded-2xl overflow-hidden bg-background card-hover cursor-pointer group">
