...
const COLOR_TOKENS = [
  "142 71% 45%",  // green #22C55E
  "199 89% 56%",  // blue #38BDF8
  "43 96% 56%",   // amber #FBBF24
];

const LightParticleReveal = () => {
  ...
  useEffect(() => {
      ...
      for (let col = 0; col < cols; col++) {
        for (let row = 0; row < rows; row++) {
          nodes.push({
            ...
            colorToken: COLOR_TOKENS[Math.floor(Math.random() * COLOR_TOKENS.length)],
          });
        }
      }
    };
    ...
    const animate = () => {
      ...
      for (const node of nodes) {
        ...
        const opacity = 0.03 + revealProgress * 0.82;
...
export default LightParticleReveal;
